...
const inputStyle: React.CSSProperties = {
  ...
  padding: '10px 12px', fontSize: 13, color: '#F4EDE1',
...
const btn: React.CSSProperties = {
  ...
  cursor: 'pointer', background: 'linear-gradient(135deg,#7BC8A0,#3D8B5E)',
  color: '#0B1829', fontSize: 12, fontWeight: 700, fontFamily: O,
};
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        {!open && (
          <button
            ...
            style={{
              fontFamily: O, fontSize: 11, fontWeight: 600, color: '#7BC8A0',
              background: 'rgba(123,200,160,.1)', border: '1px solid rgba(123,200,160,.3)',
      ...
      {open && (
        <div style={{ marginTop: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
            <button onClick={() => { setOpen(false); setError(null); }} style={{ ...btn, background: 'rgba(255,255,255,.06)', color: '#F4EDE1' }}>Cancel</button>
